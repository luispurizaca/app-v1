...
?>
<table style="width: 100%; padding: 10px; border-collapse: collapse; background: url(../../../vendors/images/marca-agua.png); background-size: 100% auto; background-position: center; background-repeat: no-repeat;">
<tr>
