...
?>
<table style="width: 100%; padding: 10px; border-collapse: collapse; background: url(../../../vendors/images/marca-agua.png?v1); background-size: 100% 100%; background-position: center; background-repeat: no-repeat;">
<tr>
