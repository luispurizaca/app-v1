...
?>
<table style="width: 100%; padding: 10px; border-collapse: collapse; background: url(../../../vendors/images/icono.png); background-size: cover; background-position: center; background-repeat: no-repeat;">
<tr>
