...
?>
<table style="width: 100%; padding: 10px; border-collapse: collapse; background: url(../../../vendors/images/marca-agua.png); background-size: 50% 50%; background-position: top; background-repeat: no-repeat;">
<tr>
