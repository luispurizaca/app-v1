...
//DATOS DEL USUARIO
$query_usuario = mysqli_query($con, "SELECT codigo, correo, nombres, apellidos, fecha_nacimiento, genero FROM usuario WHERE id = '".$_SESSION['ID_USUARIO']."' ORDER BY id ASC LIMIT 1");
...
$_SESSION['usuario_genero'] = (int)$row_usuario[5];
