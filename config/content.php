...
$password = "";
//Reconstruimos la contraseÒa segun la longitud que se quiera
for($i=0; $i< 6; $i++){
...
<li style="display: inline-block;">
<button type="button" id="filtro_anual" onclick="filtro_fechas(4)" title="Este AÒo" style="border: none; padding: 5px; font-size: 12px; background: #95cf32; color: white; outline: none;"><?php echo $texto_anual; ?></button>
</li>
