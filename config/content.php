...
<button id="btn_pd" onclick="mostrar_pa(1)" type="button" style="border: 2px solid #95cf32; color: #95cf32; background: white; font-size: 15px; padding: 5px; font-weight: bold; margin-right: 10px;">
Planes DETOX
</button>
<button id="btn_pa" onclick="mostrar_pa(2)" type="button" style="border: 2px solid #95cf32; color: #95cf32; background: white; font-size: 15px; padding: 5px; font-weight: bold; margin-left: 10px;">
...
<button type="button" style="font-size: 10px; background: none; color: orange; padding: 0px;" onclick="agregar_plan_paciente(<?php echo $id_paciente; ?>, 1, <?php echo $codigo_id_tabla; ?>)">
...
<button type="button" style="font-size: 10px; background: none; color: red; padding: 0px;">
<svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
<path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
<path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
</svg>
</button>
<button type="button" style="font-size: 10px; background: none; color: darkblue; padding: 0px;">
...
<td class="td-content" style="width: 11.11% !important;">
<button onclick="agregar_plan_paciente(<?php echo $id_paciente; ?>, 2, <?php echo $codigo_id_tabla; ?>)" type="button" style="font-size: 10px; background: #95cf32; color: white; padding: 2px;">Cargar</button>
