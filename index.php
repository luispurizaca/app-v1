...
require_once('config/is_logged.php');
require_once('config/conexion_bd.php');
require_once('config/datos_bd.php');
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
                    <div class="loader-logo"><img src="vendors/images/logo.png" style="width: 250px; height: auto;"></div>
